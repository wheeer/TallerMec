...
Partial Class Historial_Siniestros
    ...
    Private Sub InitializeComponent()
        ...
        GroupBox1.Location = New Point(186, 122)
        GroupBox1.Name = "GroupBox1"
        GroupBox1.Size = New Size(771, 507)
        ...
        Label3.Location = New Point(420, 107)
        Label3.Name = "Label3"
        ...
        cbEstado.Location = New Point(499, 102)
        cbEstado.Margin = New Padding(4, 5, 4, 5)
        cbEstado.Name = "cbEstado"
        cbEstado.Size = New Size(240, 33)
        cbEstado.TabIndex = 7
        ' 
        ' btnVerTodo
        ' 
        btnVerTodo.Location = New Point(613, 58)
        btnVerTodo.Margin = New Padding(4, 5, 4, 5)
        btnVerTodo.Name = "btnVerTodo"
        btnVerTodo.Size = New Size(126, 38)
        ...
        ' btnBuscar
        ' 
        btnBuscar.Location = New Point(499, 58)
        ...
        dgvHistorial.Location = New Point(11, 178)
        ...
        ' tbRut
        ' 
        tbRut.Location = New Point(135, 62)
        tbRut.Name = "tbRut"
        tbRut.Size = New Size(357, 31)
        tbRut.TabIndex = 1
        ' 
        ' Label1
        ' 
        ...
        Label2.Location = New Point(476, 48)
        Label2.Name = "Label2"
        ...
        ' btnVovler
        ' 
        btnVovler.Location = New Point(999, 675)
        btnVovler.Margin = New Padding(4, 5, 4, 5)
        btnVovler.Name = "btnVovler"
        btnVovler.Size = New Size(107, 38)
        ...
        PictureBox1.Size = New Size(1143, 750)
